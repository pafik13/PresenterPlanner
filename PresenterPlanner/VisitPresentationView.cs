...
{
	[Activity (Label = "VisitPresentationView", ScreenOrientation = ScreenOrientation.SensorLandscape)]			
	public class VisitPresentationView : Activity, GestureDetector.IOnGestureListener, ILocationListener
	{
